                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a href="<?php echo base_url("Educator/ManageEBooks/Edit/".$list[0]->id) ?>"
                                                        ...
                                                        <?php
                                                            ...
                                                            if(count($topicList)){
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a target="_blank" href="https://docs.google.com/viewerng/viewer?url=<?php echo $topic;?>&hl=en&embedded=true">View PDF</a>
                                                                    </td>
                                                                    <td>
                    ...
                    <div class="modal fade" id="AddModal">
                        <div class="modal-dialog">
                            <div class="modal-content border-primary">
                                ...
                                <form action="<?php echo base_url("Educator/ManageEBooks/AddTopic/".$list[0]->id); ?>" method="post"
