								...
								<div class="col-sm-12">
									<div class="card">
										<div class="card-header">
											<a class="btn btn-success" href="<?php echo base_url('Educator/ScheduleQuiz');?>"><i
													...
													<tbody>
														<?php
															...
															<tr>
																...
																<td> <?php echo $QuizData->name; ?> <a href="<?php echo base_url("Educator/ScheduleQuiz/Questions/".$item->schedule_id); ?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-eye"></i> </a></td>
		...
		<body>
												...
												<tbody>
													<?php
														...
														<tr>
															...
															<td> <a href="<?php echo base_url("Educator/ScheduleQuiz/Attend/".$item->id); ?>" class="btn btn-sm btn-success waves-effect waves-light"> Attend Students </a></td>
															<td> <?php echo $courseData->name; ?> <a href="<?php echo base_url("Educator/ManageCourses/Details/".$item->course_id); ?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-eye"></i> </a></td>
															<td> <?php echo $quizData->name; ?> <a href="<?php echo base_url("Educator/ScheduleQuiz/Questions/".$item->id); ?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-eye"></i> </a></td>
				...
				<div class="modal fade" id="AddModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ScheduleQuiz/Add"); ?>" method="post"
				...
				<div class="modal fade" id="EditModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ScheduleQuiz/Update"); ?>" method="post"
			...
			<script>
				function Edit(id) {
					...
					$("#EditModal .modal-body").load("<?php echo base_url('Educator/ScheduleQuiz/Edit/') ?>" + id);
				}
			</script>
			<script>
