    ...
    <body>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    <tr>
														...
														<td><?= $item->name; ?></td>
														<td><?= $item->no_of_questions; ?> <a href="<?=base_url('Educator/ManageQuiz/Questions/'.$item->id);?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a></td>
			...
			<div class="modal fade" id="AddModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("Educator/ManageQuiz/Add"); ?>" method="post" enctype="multipart/form-data" id="addform">
			...
			<div class="modal fade" id="EditModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("Educator/ManageQuiz/Update"); ?>" method="post" enctype="multipart/form-data" id="updateform">
							<div class="modal-body">
		...
		<script>
			function getQuestions(id){
				...
				$.ajax({
					url: "<?=base_url('Educator/ManageSubjects/QuestionsList');?>",
					type: "POST",
		...
		<script>
			function Edit(id) {
				...
				$("#EditModal .modal-body").load("<?php echo base_url('Educator/ManageQuiz/Edit/') ?>" + id);
			}
		</script>
