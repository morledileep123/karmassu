								...
								<div class="col-sm-12">
									<div class="card">
										<div class="card-header">
											<a class="btn btn-success" href="<?php echo base_url('Educator/ManageLiveVideo');?>"><i
					...
					<div class="modal fade" id="CertificateModal">
						<div class="modal-dialog modal-lg">
							<div class="modal-content border-primary">
								...
								<form action="<?php echo base_url("Educator/CertificateStatusLive/Update"); ?>" method="POST" id="registerForm">
						...
						if (check) {
							swal({
								...
								if (willDelete) {
									...
									$("#CertificateModal .modal-body").load("<?php echo base_url('Educator/CertificateStatusLive/Edit/');?>"+id+"/"+status);
								}
							});
							} else {
							var status = 'false';
			...
			<body>
				...
				<script>
        			function ReplyPost(liveid,userid,usertype,questionid){
        				...
        				$.ajax({
        					url: "<?php echo base_url("Educator/LiveReply/Add"); ?>",
        					type: "post",
		...
		<body>
														...
														<tr>
															...
															<td>
																...
																<?php if($item->certification=='Yes') {?>
																	<p> <a href="<?php echo base_url("Educator/ManageLiveVideo/Certificate/$item->id") ?>" target="_blank" class="text-info">View Certificate</a></p>
															...
															<td>
																...
																<div class="btn-group">
																     <a href="<?php echo base_url('Educator/ManageLiveVideo/Joined/'.$item->id);?>"  class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Joined</a>
																	 <a href="<?php echo base_url('Educator/ManageLiveVideo/Questions/'.$item->id);?>"  class="btn btn-sm btn-primary"><i class="fa fa-info"></i> Questions</a>
																	<a href="javascript:void(0);"
				...
				<div class="modal fade" id="AddModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ManageLiveVideo/Add"); ?>" method="post"
				...
				<div class="modal fade" id="EditModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ManageLiveVideo/Update"); ?>" method="post"
				...
				<div class="modal fade" id="StartModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ManageLiveVideo/StartLiveSession"); ?>" method="post"
				...
				<div class="modal fade" id="EndModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							...
							<form action="<?php echo base_url("Educator/ManageLiveVideo/EndLiveSession"); ?>" method="post"
							enctype="multipart/form-data" id="updateform1">
								<div class="modal-body">
			...
			<script>
				function Edit(id) {
					...
					$("#EditModal .modal-body").load("<?php echo base_url('Educator/ManageLiveVideo/Edit/') ?>" + id);
				}
				function StartLiveSession(id) {
					$("#StartModal").modal("show");
					$("#StartModal .modal-body").html("<center><i class='fa fa-2x fa-spin fa-spinner'></i></center>");
					$("#StartModal .modal-body").load("<?php echo base_url('Educator/ManageLiveVideo/StartLiveSession/') ?>" + id);
				}
				function EndLiveSession(id) {
					$("#EndModal").modal("show");
					$("#EndModal .modal-body").html("<center><i class='fa fa-2x fa-spin fa-spinner'></i></center>");
					$("#EndModal .modal-body").load("<?php echo base_url('Educator/ManageLiveVideo/EndLiveSession/') ?>" + id);
				}
			</script>
