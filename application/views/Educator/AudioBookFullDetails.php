                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a href="<?php echo base_url("Educator/ManageAudioBooks/Edit/".$list[0]->id) ?>"
                        ...
                        <div class="modal fade" id="AddModal">
                            <div class="modal-dialog">
                                <div class="modal-content border-primary">
                                    ...
                                    <form action="<?php echo base_url("Educator/ManageAudioBooks/AddTopic/".$list[0]->id); ?>" method="post"
