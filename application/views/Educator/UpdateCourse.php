                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="<?php echo base_url("Educator/ManageCourses/Update"); ?>" method="post" enctype="multipart/form-data" id="addform" >
                                        ...
                                        <div class="form-group row d-none">
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="author"  required value="<?=$this->author;?>">
                                        ...
                                        <div  id="certificatediv">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <p id="certificateThemePreview"><?php if($list[0]->certification=='Yes'){ echo '<a href="'.base_url("Educator/ManageCourses/Certificate/".$list[0]->id).'" target="_blank" class="text-info">View Certificate</a>';}?></p>
                                                </div>
                                            </div>
                                            <div class="form-group row">
