    ...
    <body>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
									...
									<a href="<?=base_url('uploads/excel/Sample-Excel-File-Upload-Question.xlsx');?>" class="btn btn-danger"> <i class="fa fa-download" aria-hidden="true"></i> Download Sample File</a>
								</div>
                                <div class="card-body">
			...
			<div class="modal fade" id="AddModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("Educator/ManageQuestions/Add"); ?>" method="post" enctype="multipart/form-data" id="addform">
			...
			<div class="modal fade" id="EditModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("Educator/ManageQuestions/Update"); ?>" method="post" enctype="multipart/form-data" id="updateform">
							<div class="modal-body">
			...
			<div class="modal fade" id="UploadQuestionModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("Educator/ManageQuestions/Upload"); ?>" method="post" enctype="multipart/form-data" id="uploadForm">
							<div class="modal-body">
								<div class="row">
									<input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
									<div class="form-group col-sm-12">
										<label class="col-form-label">Choose Excel File <span class="text-danger">*</span></label>
										<input type="file" class="form-control dropify" data-height="150" name="excelfile" Title="Choose Excel File"  accept= "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"  required>
		...
		<script>
			function Edit(id) {
				...
				$("#EditModal .modal-body").load("<?php echo base_url('Educator/ManageQuestions/Edit/') ?>" + id);
			}
		</script>
