										...
										<div class="col-sm-3">
											<div class="card">
												<div class="card-header p-0">
													<a href="<?php echo base_url('Educator/Videos/'.$type.'/'.$item->id);?>"><img src="<?php echo base_url('uploads/thumbnail/'.$item->video->thumbnail);?>"  class="card-img-top"  style="height:200px;"></a>
												</div>
												<div class="card-body">
													...
													<ul class="list-group list-group-flush list shadow-none p-0 text-center">
														<li class="list-group-item d-flex justify-content-center align-items-center p-1">
															...
															<a href="<?php echo base_url('Educator/Videos/'.$type.'/'.$item->id);?>" class="btn btn-info p-2"> <i class="fa fa-play-circle"></i> Play Now</a>
