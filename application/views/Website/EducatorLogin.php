			...
			<div class="card card-authentication1 mx-auto my-5"> 
				<div class="card-body">
					<div class="card-content p-2">   
						...
						<div class="card-title text-uppercase text-center py-3">Educator Login</div>
						<form method="post" action="<?php echo base_url("Home/EducatorLogin"); ?>">
							...
							<button type="submit" name="educatorlogin" value="educatorlogin" class="btn btn-primary btn-block">Login</button>
				...
				<div class="card-footer text-center py-3">
					<p class="text-dark mb-0">Don't have an account? <a href="<?php echo base_url('Home/EducatorRegistration');?>"> Register Now </a></p>
				</div>
			</div>
