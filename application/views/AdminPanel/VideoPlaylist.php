    ...
    <body>
								...
								<ul class="list-group list-group-flush">
									...
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<div class="star">
												<a href="<?php echo base_url('AdminPanel/VideoPlaylist/'.$list[0]->course->id.'/'.$item->video[0]->id); ?>" class="btn btn-info p-2"> <i class="fa fa-play-circle"></i> Play</a>
											</div>
										</div>
									</li>
									<?php endforeach; ?>
												...
												<div class="media align-items-center">
													<div class="media-body ml-3">
														<div class="row">
															...
															<div class="col-sm-6">
																<button class="btn btn-dark" onclick="ReplyPost('<?php echo $list[0]->course->id;?>','<?php echo $list[0]->video->id;?>','<?php echo 1;?>','Admin','<?php echo $item->id;?>')"> <i class="fa fa-reply"></i> </button>
		...
		<script>
			function ReplyPost(courseid,videoid,userid,usertype,questionid){
				...
				$.ajax({
					url: "<?php echo base_url("AdminPanel/VideoReply/Add"); ?>",
					type: "post",
