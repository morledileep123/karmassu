    ...
    <body> 
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
									...
									class="fa fa-plus-circle"></i> Add Certificate</button>
								</div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox"
                                                            onchange="return Status(this,'tbl_certificate','id','<?php echo $item->id; ?>','status')"
														...
														<td> <label data-toggle="tooltip" data-placement="top"
															title="Certificate ID: <?php echo $item->id; ?>"><a
																href="<?php echo base_url("uploads/certificate/$item->image"); ?>"
																target="_blank"><img
																	data-src="<?php echo base_url("uploads/certificate/$item->image"); ?>"
														...
														<td>
															<a href="<?php echo base_url("AdminPanel/ManageCertificates/View/$item->id"); ?>" class="text-info">View Certificate</a>
														</td>
														...
														<td>
															...
															<div class="btn-group">
																...
																onclick="return Delete(this,'tbl_certificate','id','<?php echo $item->id; ?>','certificate','image')">
			...
			<div class="modal fade" id="AddModal">
				<div class="modal-dialog modal-lg">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("AdminPanel/ManageCertificates/Add"); ?>" method="post"
						enctype="multipart/form-data" id="addform">
							<div class="modal-body">
								...
								<div class="form-group">
									<label class="col-form-label"> Certificate Name<span class="text-danger">*</span></label>
									<input type="text" class="form-control" name="name" placeholder="Certificate Name" required >
									<?php echo form_error("name", "<p class='text-danger' >", "</p>"); ?>
								</div>
								<div class="form-group">
									<label class="col-form-label">Certificate <span class="text-danger">*</span></label>
									<input type="file" class="form-control" name="certificate" Title="Choose Image" required >
									<?php echo form_error("image", "<p class='text-danger' >", "</p>"); ?>
								</div>
								<div class="form-group">
									<label class="col-form-label">Certificate Image <span class="text-danger">*</span></label>
			...
			<div class="modal fade" id="EditModal">
				<div class="modal-dialog modal-lg">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("AdminPanel/ManageCategories/Update"); ?>" method="post"
		...
		<script>
			function Edit(id) {
				...
				$("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/ManageCertificates/Edit/') ?>" + id);
			}
		</script>
						...
						if (willDelete) {
							$.ajax({
								...
								success: function(response) {
									swal("This Certificate is activated successfully !", {
										icon: "success",
									});
								}
							});
					...
					swal({
						...
						if (willDelete) {
							$.ajax({
								...
								success: function(response) {
									swal("This Certificate is deactivated successfully !", {
										icon: "success",
									});
								}
							});
				...
				swal({
					...
					if (willDelete) {
						$.ajax({
							...
							success: function(response) {
								swal("This Certificate is deleted successfully !", {
									icon: "success",
								});
								location.reload();
							}
