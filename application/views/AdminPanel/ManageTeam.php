...
<body> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#AddModal"><i
                                        class="fa fa-plus-circle"></i> Add Team</button>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered wrap" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox"
                                                        onchange="return Status(this,'tbl_team','id','<?php echo $item->id; ?>','status')"
                                                ...
                                                <td> <label data-toggle="tooltip" data-placement="top"
                                                        title="Team ID: <?php echo $item->id; ?>"><a
                                                            href="<?php echo base_url("uploads/team/$item->photo"); ?>"
                                                            target="_blank"><img
                                                                data-src="<?php echo base_url("uploads/team/$item->photo"); ?>"
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            onclick="return Delete(this,'tbl_team','id','<?php echo $item->id; ?>','team','photo')">
            ...
            <div class="modal-dialog">
                <div class="modal-content border-primary">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white">Add Team</h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?php echo base_url("AdminPanel/ManageTeam/Add"); ?>" method="post"
                        ...
                        <div class="modal-footer d-block">
                            <button type="submit" id="addaction" name="addaction" class="btn btn-primary"><i
                                    class="icon-lock"></i> Add Team</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="EditModal">
            <div class="modal-dialog">
                <div class="modal-content border-primary">
                    ...
                    <form action="<?php echo base_url("AdminPanel/ManageTeam/Update"); ?>" method="post"
                        ...
                        <div class="modal-footer d-block">
                            ...
                            <button type="submit" id="updateaction" name="updateaction" class="btn btn-primary"><i
                                    class="icon-lock"></i> Update Team</button>
                        </div>
                    </form>
    ...
    function Edit(id) {
        ...
        $("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/ManageTeam/Edit/') ?>" + id);
    }
    </script>
    ...
    function Status(e, table, where_column, where_value, column) {
        ...
        if (check) {
            swal({
                title: "Are you sure?",
                text: "You want to activate this team member!",
                icon: "warning",
                buttons: true,
                dangerMode: true
            }).then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function(response) {
                            swal("This team member is activated successfully !", {
                                icon: "success",
                            });
                        }
                    });
            ...
            swal({
                title: "Are you sure?",
                text: "You want to deactivate this team member !",
                icon: "warning",
                buttons: true,
                dangerMode: true
            }).then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function(response) {
                            swal("This team member is deactivated successfully !", {
                                icon: "success",
                            });
                        }
                    });
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    ...
                    success: function(response) {
                        swal("This team member is deleted successfully !", {
                            icon: "success",
                        });
                        location.reload();
                    }
