...
<body>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#AddModal"><i
                                        class="fa fa-plus-circle"></i> Add Testimonial</button>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered wrap" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox"
                                                        onchange="return Status(this,'tbl_testimonial','id','<?php echo $item->id; ?>','status')"
                                                ...
                                                <td> <label data-toggle="tooltip" data-placement="top"
                                                        title="Testimonial ID: <?php echo $item->id; ?>"><a
                                                            href="<?php echo base_url("uploads/testimonial/$item->photo"); ?>"
                                                            target="_blank"><img
                                                                data-src="<?php echo base_url("uploads/testimonial/$item->photo"); ?>"
                                                                src="<?php echo base_url("images/Preloader2.jpg"); ?>"
                                                                class="lazy" style="height:50px;" /> </a></label>
                                                </td>
                                                <td>
                                                    <?php echo str_replace('.', '.<br>', $item->review); ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            onclick="return Delete(this,'tbl_testimonial','id','<?php echo $item->id; ?>','testimonial','photo')">
        ...
        <div class="modal fade" id="AddModal">
            <div class="modal-dialog">
                <div class="modal-content border-primary">
                    ...
                    <form action="<?php echo base_url("AdminPanel/ManageTestimonials/Add"); ?>" method="post"
                        ...
                        <div class="modal-footer d-block">
                            <button type="submit" id="addaction" name="addaction"
                                class="btn btn-primary"><i class="icon-lock"></i> Add Testimonial</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="EditModal">
            <div class="modal-dialog">
                <div class="modal-content border-primary">
                    ...
                    <form action="<?php echo base_url("AdminPanel/ManageTestimonials/Update"); ?>" method="post"
                        ...
                        <div class="modal-footer d-block">
                            ...
                            <button type="submit" id="updateaction" name="updateaction"
                                class="btn btn-primary"><i class="icon-lock"></i> Update Testimonial</button>
                        </div>
                    </form>
    ...
    function Edit(id) {
        ...
        $("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/ManageTestimonials/Edit/') ?>" + id);
    }
    </script>
    <script>
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function(response) {
                            swal("This testimonial is activated successfully !", {
                                icon: "success",
                            });
                        }
                    });
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function(response) {
                            swal("This testimonial is deactivated successfully !", {
                                icon: "success",
                            });
                        }
                    });
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    ...
                    success: function(response) {
                        swal("This testimonial is deleted successfully !", {
                            icon: "success",
                        });
                        location.reload();
                    }
