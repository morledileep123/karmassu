			...
			<div class="content-wrapper">
				<div class="container-fluid">
					<div class="row pt-2 pb-2">
						<div class="col-sm-9">
							<h4 class="page-title"> A-Book Enrollments</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="javaScript:void();">A-Book</a></li>
								<li class="breadcrumb-item active" aria-current="page">A-Book Enrollments</li>
							</ol>
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<a class="btn <?php if($this->uri->segment(3)=='success'){ echo 'btn btn-success'; } else{ echo 'btn btn-outline-success'; }?>" href="<?php echo base_url('AdminPanel/ABookEnrollments/success');?>">Success</a>
									<a class="btn <?php if($this->uri->segment(3)=='failed'){ echo 'btn btn-danger'; } else{ echo 'btn btn-outline-danger'; }?>" href="<?php echo base_url('AdminPanel/ABookEnrollments/failed');?>">Failed</a>
									<a class="btn <?php if($this->uri->segment(3)=='Pending'){ echo 'btn btn-warning'; } else{ echo 'btn btn-outline-warning'; }?>" href="<?php echo base_url('AdminPanel/ABookEnrollments/Pending');?>">Pending</a>
								</div>
								<div class="card-header">
											...
											<tbody>
												<?php
													...
													<tr>
														...
														<td>
															<a href="<?php echo base_url("AdminPanel/ManageAudioBooks/Details/$item->itemid") ?>"
