    ...
    <body>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox"
                                                            onchange="return Status(this,'tbl_category','id','<?php echo $item->id; ?>','status')"
                                                        ...
                                                        <td> <label data-toggle="tooltip" data-placement="top"
                                                            title="Category ID: <?php echo $item->id; ?>"><a
                                                                href="<?php echo base_url("uploads/category/$item->icon"); ?>"
                                                                target="_blank"><img
                                                                    data-src="<?php echo base_url("uploads/category/$item->icon"); ?>"
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                onclick="return Delete(this,'tbl_category','id','<?php echo $item->id; ?>','category','icon')">
            ...
            <div class="modal fade" id="AddModal">
                <div class="modal-dialog">
                    <div class="modal-content border-primary">
                        ...
                        <form action="<?php echo base_url("AdminPanel/ManageCategories/Add"); ?>" method="post"
                        enctype="multipart/form-data" id="addform">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="color" placeholder="Enter  Color Code"
                                    required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="icon" Title="Choose Icon" required accept="image/jpg, image/png, image/jpeg, image/gif">
                            ...
                            <div class="modal-footer">
                                ...
                                class="icon-lock"></i> Add Category</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="modal-content border-primary">
                        ...
                        enctype="multipart/form-data" id="updateform">
                            ...
                            <div class="modal-footer d-block">
                                ...
                                class="icon-lock"></i> Update Category</button>
                            </div>
                        </form>
        ...
        <script>
            function Edit(id) {
                ...
                $("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/ManageCategories/Edit/') ?>" + id);
            }
        </script>
                        ...
                        if (willDelete) {
                            $.ajax({
                                ...
                                success: function(response) {
                                    swal("This category is activated successfully !", {
                                        icon: "success",
                                    });
                                }
                            });
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            $.ajax({
                                ...
                                success: function(response) {
                                    swal("This category is deactivated successfully !", {
                                        icon: "success",
                                    });
                                }
                            });
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(response) {
                                swal("This category is deleted successfully !", {
                                    icon: "success",
                                });
                                location.reload();
                            }
