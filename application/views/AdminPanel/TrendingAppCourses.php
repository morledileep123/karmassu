    ...
    <body>
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pt-2 pb-2">
                        <div class="col-sm-9">
                            <h4 class="page-title"> Trending App Courses</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javaScript:void();">App Management</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Trending App Courses</li>
							</ol>
						</div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
									...
									class="fa fa-plus-circle"></i> Set Trending Courses</button>
								</div>
                                <div class="card-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content border-primary">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title text-white">Trending Course</h5>
                            <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
							</button>
						</div>
                        <form action="<?php echo base_url("AdminPanel/TrendingAppCourses/Add"); ?>" method="post"
                        enctype="multipart/form-data" id="addform">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
										<label>Trending Courses <span class="text-danger">*</span></label>
										<!--
        ...
        <script>
            function Status(e, table, where_column, where_value, column) {
                swal({
					title: "Are you sure?",
					text: "You want to remove this course from trending !",
					icon: "warning",
					buttons: true,
					dangerMode: true
					}).then((willDelete) => {
					if (willDelete) {
						$.ajax({
							...
							success: function(response) {
								swal("This course is removed from trending.", {
									icon: "success",
								});
								location.reload();
							}
