            ...
            <div class="modal fade" id="AddModal">
                <div class="modal-dialog">
                    <div class="modal-content border-primary">
                        ...
                        <form action="<?php echo base_url("AdminPanel/ManageSliders/Add"); ?>" method="post"
                        enctype="multipart/form-data" id="addform">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden"  name="slidertype" value="Website">
                                ...
                                <!--
                                    <div class="form-group">
                                    <label class="col-form-label">Slider Type <span class="text-danger">*</span></label>
                                    <select class="form-control" name="slidertype" title="Select Slider Type"
                                    required>
                                    <option value="">--Choose Type--</option>
                                    <option value="Website">For Website</option>
                                    <option value="App">For App</option>
                                    <option value="Both">For Both</option>
                                    </select>
                                    <?php echo form_error("slidertype", "<p class='text-danger' >", "</p>"); ?>
                                    </div>
                                -->
            ...
            <div class="modal fade" id="EditModal">
                <div class="modal-dialog">
                    <div class="modal-content border-primary">
                        ...
                        <form action="<?php echo base_url("AdminPanel/ManageSliders/Update"); ?>" method="post"
