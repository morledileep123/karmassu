                                        ...
                                        <table class="table table-bordered" id="example">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    <tr>
                                                        <td><?php echo $sr; ?></td>
                                                        <td><?php echo $item->author->name.' ('.$item->author->designation.')'; ?><br>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if($item->certification=='Yes') {?>
                                                                <p> <a href="<?php echo base_url("AdminPanel/ManageCourses/Certificate/$item->id") ?>" target="_blank" class="text-info">View Certificate</a></p>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <a href="<?php echo base_url("AdminPanel/ManageCourses/Edit/$item->id") ?>"
