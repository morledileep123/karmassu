                    ...
                    <div class="row pt-2 pb-2">
                        <div class="col-sm-9">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="ManageOffers">Manage Offers</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Used Coupon History</li>
							</ol>
						</div>
                        <div class="col-sm-3">
                                            ...
                                            <tbody>
                                                <?php
													...
													<tr>
														<td><?php echo $sr; ?></td>
														<td>
															<a href="<?php echo base_url('AdminPanel/ManageStudents/Profile/'.$item->userid);?>" class="btn btn-info p-1"> <i class="fa fa-user-circle"></i> Student Profile</a>
														</td>
														<td>
