        ...
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pt-2 pb-2">
                        <div class="col-sm-9">
                            <h4 class="page-title">App Splash Screen</h4>
						</div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
									...
									class="fa fa-plus-circle"></i> Add Splash Screen</button>
								</div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    <tr>
                                                        <td><?php echo $sr; ?></td>
                                                        <td>
                                                            <input type="checkbox" onchange="return Status(this,'tbl_splash_screen','id','<?php echo $item->id; ?>','status')"
															...
															<td> 
																<a href="<?=base_url('uploads/splash_screen/'.$item->screen);?>" target="_blank">View Splash Screen</a>
															</td>
															...
															<td>
																...
																<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger waves-effect waves-light" onclick="return Delete(this,'tbl_splash_screen','id','<?php echo $item->id; ?>','splash_screen','screen')"> <i class="fa fa-trash"></i> </a>
															</td>
														</tr>
														<?php
															$sr++;
					...
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							<div class="modal-header bg-primary">
								<h5 class="modal-title text-white">Add Splash Screen</h5>
								<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<form action="<?php echo base_url("AdminPanel/AppSplashScreen/Add"); ?>" method="post"
							enctype="multipart/form-data" id="addform">
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<input type="file" class="form-control" name="screen" title="Upload Splash Screen"
										required accept="image/jpg, image/png, image/jpeg, image/gif,video/mp4">
				...
				<div class="modal fade" id="EditModal">
					<div class="modal-dialog">
						<div class="modal-content border-primary">
							<div class="modal-header bg-primary">
								<h5 class="modal-title text-white">Edit Splash Screen</h5>
								<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							
							<form action="<?php echo base_url("AdminPanel/AppSplashScreen/Update"); ?>" method="post"
							enctype="multipart/form-data" id="updateform">
								...
								<div class="modal-footer d-block">
									...
									class="btn btn-primary"><i class="icon-lock"></i> Update Splash Screen</button>
								</div>
							</form>
			...
			<script>
				function Edit(id) {
					...
					$("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/AppSplashScreen/Edit/') ?>" + id);
				}
			</script>
			<script>
				function Status(e, table, where_column, where_value, column) {
					...
					if (check) {
						swal({
							title: "Are you sure?",
							text: "You want to activate this screen !",
							icon: "warning",
							buttons: true,
							dangerMode: true
							}).then((willDelete) => {
							if (willDelete) {
								$.ajax({
									url: "<?php echo base_url("AdminPanel/AppSplashScreen/UpdateStatus"); ?>",
									type: "post",
									data: {
										'table': table,
										'column': column,
									...
									success: function(response) {
										...
										swal("This screen is activated successfully !", {
											icon: "success",
										});
									}
								});
						...
						swal({
							title: "Are you sure?",
							text: "You want to deactivate this screen !",
							icon: "warning",
							buttons: true,
							dangerMode: true
							}).then((willDelete) => {
							if (willDelete) {
								$.ajax({
									...
									success: function(response) {
										swal("This screen is deactivated successfully !", {
											icon: "success",
										});
									}
								});
					...
					swal({
						...
						if (willDelete) {
							$.ajax({
								...
								success: function(response) {
									swal("This screen is deleted successfully !", {
										icon: "success",
									});
									location.reload();
								}
