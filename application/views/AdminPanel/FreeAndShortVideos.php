    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pt-2 pb-2">
                        <div class="col-sm-9">
                            <h4 class="page-title"> Free Videos & Short Tricks/Tips</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void();">Manage Videos</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Free Videos & Short Tricks/Tips</li>
							</ol>
						</div>
                        <div class="col-sm-3">
			...
			<div class="modal fade" id="AddModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						...
						<form action="<?php echo base_url("AdminPanel/FreeAndShortVideos/Add"); ?>" method="post"
							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="type" required>
										...
										<option value="FreeVideos">Free Videos</option>
										<option value="ShortTricks">Short Tricks</option>
			...
			<div class="modal fade" id="EditModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						<div class="modal-header bg-primary">
							<h5 class="modal-title text-white">Edit Recommended Video</h5>
							<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						
						<form action="<?php echo base_url("AdminPanel/FreeAndShortVideos/Update"); ?>" method="post"
		...
		<script>
			function Edit(id) {
				...
				$("#EditModal .modal-body").load("<?php echo base_url('AdminPanel/FreeAndShortVideos/Edit/') ?>" + id);
			}
		</script>
