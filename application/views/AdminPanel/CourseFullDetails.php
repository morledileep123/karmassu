        ...
        <div id="wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <p><strong><i class="fa fa-certificate text-primary"></i> 
                                                <?php 
                                                    if($list[0]->certification == "Yes"){
                                                        echo 'Certification';
                                                    ?>
                                                    <p> <a href="<?php echo base_url("AdminPanel/ManageCourses/Certificate/".$list[0]->id) ?>" target="_blank" class="text-info">View Certificate</a></p>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a href="<?php echo base_url("AdminPanel/ManageCourses/Edit/".$list[0]->id) ?>"
                                                        ...
                                                        <?php
                                                            ...
                                                            if(count($lecture)){
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="<?php echo base_url('AdminPanel/VideoPlaylist/'.$list[0]->id.'/'.$item->video[0]->id); ?>" class="btn btn-info btn-sm"> <i class="fa fa-play-circle"></i> Play</a>
                                                                        <input type="checkbox"
                                                                        ...
                                                                        class="fa fa-plus-circle"></i> Abhyaas</button>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        title="ID: <?php echo $item->video[0]->id; ?>"><a
                                                                            href="<?php echo base_url("uploads/thumbnail/".$item->video[0]->thumbnail); ?>"
                                                                            target="_blank"><img
                                                                                data-src="<?php echo base_url("uploads/thumbnail/".$item->video[0]->thumbnail); ?>"
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>
                                                                            <a
                                                                            href="<?php echo base_url("uploads/video/".$item->video[0]->video); ?>"
                                                                            target="_blank">
                                                                                <video controls src="<?php echo base_url("uploads/video/".$item->video[0]->video); ?>" style="height:100px;" ></video> 
                                                                            </a>
            ...
            <div class="modal fade" id="AddModal">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content border-primary">
                        ...
                        <form action="<?php echo base_url("AdminPanel/ManageCourses/AddLecture/".$list[0]->id); ?>" method="post"
                        enctype="multipart/form-data" id="addform">
                            <div class="modal-body row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    placeholder="Description" required style="height:200px;"></textarea>
			...
			<div class="modal fade" id="AddAssignmentModal">
				<div class="modal-dialog">
					<div class="modal-content border-primary">
						<div class="modal-header bg-primary">
							<h5 class="modal-title text-white">Add Abhyaas</h5>
							<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
                            </button>
                        </div>
						<form action="<?php echo base_url("AdminPanel/ManageCourses/AddAssignment/".$list[0]->id); ?>" method="post"
