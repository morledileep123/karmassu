...
<html lang="en">
    <head>
        <title>Karmasu | Student | E-Books</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 p-2"><h5 class="pull-left">E-Books</h5></div>
                        <?php
                            if(count($ebookList)){
                            ...
                            <div class="col-sm-12">
                                <center>
                                    <img src="<?php echo base_url('image/NoRecordFound.png');?>" title="image not found" alt="image not found" class="img-fluid"/>
                                    <br><br>
                                    <br><br><br><br>
                                </center>
                            </div>
