...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row p-2">
				<div class="col-sm-4">
					<img src="<?=base_url();?>images/iso-certifed.png" style="height: 100px;">
					
				</div>
				<div class="col-sm-4 text-center">
					<h1 id='cert-holder'>
						<span style="color:#2a176f"><b>C</b></span>ertificate
					</h1>
					<p>of completion</p>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-12 text-center">
					...
					<p>Mr/Ms/Mrs &nbsp;<strong style="border-bottom:3px dotted;"><?php echo $name;?></strong> &nbsp;</p>
